...
cd 
wget -O /usr/local/bin/ohp "https://raw.githubusercontent.com/NevermoreSSH/bullseye/main/FILE/OPENVPN/ohp"
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By NevermoreSSH
