...
function addtrojan(){
source /var/lib/nevermoressh-pro/ipvps.conf
...
trojanlink="trojan://${uuid}@${domain}:${tr}?path=%2Fnevermoressh&security=tls&host=bug.com&type=ws&sni=bug.com#${user}"
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}           ${WH}• CREATE TROJAN USER •              ${NC} $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
echo -e "$COLOR1 ${NC} ${WH}Path        ${COLOR1}: ${WH}/nevermoressh (/Custom path)"
echo -e "$COLOR1 ${NC} ${WH}Path WSS    ${COLOR1}: ${WH}wss://bug.com/nevermoressh (/Custom path)" 
