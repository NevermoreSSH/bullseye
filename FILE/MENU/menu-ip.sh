...
colornow=$(cat /etc/nevermoressh/theme/color.conf)
NC="\e[0m"
COLOR1="$(cat /etc/nevermoressh/theme/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
COLBG1="$(cat /etc/nevermoressh/theme/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')"
WH='\033[1;37m'

APIGIT=$(cat /etc/nevermoressh/github/api)
EMAILGIT=$(cat /etc/nevermoressh/github/email)
USERGIT=$(cat /etc/nevermoressh/github/username)
...
if [[ -f /etc/nevermoressh/github/api && -f /etc/nevermoressh/github/email && /etc/nevermoressh/github/username ]]; then
   rec="OK"
else
    mkdir /etc/nevermoressh/github > /dev/null 2>&1
fi
...
echo -e "$COLOR1 ${NC}                ${WH}• NevermoreSSH •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e ""
...
sleep 2
echo "$EMAIL1" > /etc/nevermoressh/github/email
echo "$USERNAME1" > /etc/nevermoressh/github/username
echo "$API1" > /etc/nevermoressh/github/api
echo "ON" > /etc/nevermoressh/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
function resetipvps(){
clear
rm -f /etc/nevermoressh/github/email
rm -f /etc/nevermoressh/github/username
rm -f /etc/nevermoressh/github/api
rm -f /etc/nevermoressh/github/gitstat
echo "OFF" > /etc/nevermoressh/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1 ${NC} [INFO] PM : t.me/todfix667/"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── ${WH}BY${NC} ${COLOR1}───────────────────────┐${NC}"
echo -e "$COLOR1 ${NC}                ${WH}• 𝔻ℝ𝕐𝔸ℕℤ 𝕊ℂℝ𝕀ℙ𝕋 •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/nevermoressh/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/nevermoressh/github
    touch /etc/nevermoressh/github/gitstat
    echo "OFF" > /etc/nevermoressh/github/gitstat
fi

stst1=$(cat /etc/nevermoressh/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               ${WH}• REGISTER IPVPS •              ${NC} $COLOR1 $NC"
...
stst=$(cat /etc/nevermoressh/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
