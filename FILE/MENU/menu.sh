...
export COLOR1="$(cat /etc/nevermoressh/theme/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
export COLBG1="$(cat /etc/nevermoressh/theme/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')" 
WH='\033[1;37m'                   
###########- NevermoreSSH-##########
...
echo "IP=$host" > /var/lib/nevermoressh-pro/ipvps.conf
echo ""
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/NevermoreSSH/bullseye/main/FILE/PLUGINS/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/NevermoreSSH/bullseye/main/FILE/PLUGINS/versi)
...
serverV=$( curl -sS https://raw.githubusercontent.com/NevermoreSSH/bullseye/main/FILE/PLUGINS/versi)
