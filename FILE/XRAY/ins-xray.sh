...
wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/NevermoreSSH/bullseye/main/FILE/SSH/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
sleep 1
wget -q -O /usr/bin/auto-set "https://raw.githubusercontent.com/NevermoreSSH/bullseye/main/FILE/XRAY/auto-set.sh" && chmod +x /usr/bin/auto-set 
wget -q -O /usr/bin/crtxray "https://raw.githubusercontent.com/NevermoreSSH/bullseye/main/FILE/XRAY/crt.sh" && chmod +x /usr/bin/crtxray 
sleep 1
